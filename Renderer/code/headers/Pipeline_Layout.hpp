...
namespace Renderer_System
{
    ...
    public:
        ...
        Pipeline_Layout(const Vulkan_Device& _device,
        ...
        // Used by vkCmdBindDescriptorSets and vkCmdPushConstants.
        VkPipelineLayout Get_handle() const { return pipeline_layout; }

        // Needed by whoever allocates the per-frame UBO descriptor sets.
